...
for ssp in ssp126 ssp370 ssp585;do for gcm in CanESM5 ACCESS-ESM1-5 GFDL-ESM4 CNRM-ESM2-1 IPSL-CM6A-LR BCC-CSM2-MR;do curl -OL https://geodata.ucdavis.edu/cmip6/30s/${gcm}/${ssp}/wc2.1_30s_bioc_${gcm}_${ssp}_2081-2100.tif ;done;done
